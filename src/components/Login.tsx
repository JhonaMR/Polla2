  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        console.log('[LOGIN] Login completado, redirección automática...');
      } else {
        console.log('[LOGIN] Procesando registro...');
        await register(name, username, password);
        console.log('[LOGIN] Registro completado, redirección automática...');
      }
    } catch (err: any) {
